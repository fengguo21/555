...
<template>
	<div class="release_need">
		<div class="address" :class="{'addAddress':obj.addAddress}" @click="selectPlace">
			<div class="left">{{obj.address_name}}</div>
			<div class="content">
				<div class="ads">
					<span class="placeholder" v-show="!obj.addressProvince">
						请选择{{obj.address_name}}
					</span>
					{{ obj.addressProvince }}
					<span v-show="obj.addressCity">,</span> {{ obj.addressCity }}
					<span v-show="obj.addressDistrict">,</span> {{obj.addressDistrict}}
				</div>
				<div class="img">
			...
			<div class="bottom">
				<div class="address_box">
					<div class="confirm">
						...
						<div class="btn comfire" @click="confirmIt">确定</div>
					</div>
